...
import bg.fmi.cookingplanner.search.adapters.EditTextViewAdapter;
import bg.fmi.cookingplanner.search.adapters.FoodTypesAdapter;
import bg.fmi.cookingplanner.search.adapters.MissingIngredientsAdapter;
 ...
 */
public class MissingIngredientsView implements bg.fmi.cookingplanner.search.views.View {
