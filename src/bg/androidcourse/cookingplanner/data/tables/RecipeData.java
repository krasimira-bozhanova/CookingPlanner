...
import bg.androidcourse.cookingplanner.models.Content;
import bg.androidcourse.cookingplanner.models.Description;
import bg.androidcourse.cookingplanner.models.Image;
...
public class RecipeData extends Data {
    ...
    public String getCreateTableStatement() {
        return "CREATE TABLE IF NOT EXISTS " + getTableName()
                ...
                + TypeData.getInstance().getTableName() + "(_id) " + ");";
    }
    ...
    public long createRecipe(Recipe recipe) {
        ...
        long typeId = TypeData.getInstance().getTypeId(recipe.getType());
    ...
    private Recipe constructRecipefFromCursor(Cursor cursor) {
        ...
        Type type = TypeData.getInstance().getType(typeId);
        ...
        return new Recipe(id, name, description, content, time, images, type,
